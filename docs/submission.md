...
## Core Features
### Token Intel
Analyze token context, liquidity, activity, signal quality, and risk.

### Wallet Intel
Interpret wallet behavior, concentration, exposure, and risk posture.

### Watch Today
Summarize top narratives, strongest signals, and major risk zones.
...
- interprets wallet behavior, not just balances
- focuses on **conviction**, not raw noise
- uses real Binance Skills Hub capabilities
- easy to demo in a chat workflow
