...
.PHONY: token wallet watchtoday signal check test runtime-demo api bridge-api bridge-live square-draft square-publish diary-night daily-post install-diary-cron
